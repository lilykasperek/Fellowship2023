...
source("multiple_pdf_function.R")
check_1 <- multiple_pdf_function("STAT113_Fall_2020_2.pdf") |> print(n = 78)
check_2 <- multiple_pdf_function("STAT113_Spring_2020_2.pdf") |> print(n = 78)
check_3 <- bind_rows(check_1, check_2) |>
  filter(question_hm == "Q1")
ggplot(data = check_3, aes(x = count_hm, y = responses_hm,
                           fill = responses_hm)) +
  geom_col() +
  facet_wrap(~Semester + course, ncol = 1) 
```
