...
```{r}
library(stringr)
info_113 <- noquote(first_page[[2]])
info_113
info_234 <- noquote(first_page_2[[2]])
info_234

course_info_1 <- strsplit(info_113, "-")
course_info_1[[1]][3] <- str_replace_all(course_info_1[[1]][3], " ", "")
course_info_1 <- noquote(course_info_1)
course_info_1 

course_info_1[[1]][1]


# course number, subject, semester, and year
meta_test <- tibble::tibble(course_num = only_numbers[[2]][3],
                            subject = course_info_1[[1]][3],
                            year = only_numbers[[2]][1])
meta_test

course_info_2 <- strsplit(info_234, "-")
course_info_2[[1]][3] <- str_replace_all(course_info_2[[1]][3], " ", "")
course_info_2 <- noquote(course_info_2)
course_info_2

meta_test_2 <- tibble::tibble(course_num = only_numbers_234_1[[2]][3],
                            subject = course_info_2[[1]][3],
                            year = only_numbers_234_1[[2]][1])
meta_test_2

# need to figure out how to scrape semester 
