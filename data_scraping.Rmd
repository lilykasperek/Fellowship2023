...
noquote(one_table[1] |> strsplit("Q6b: I would recommend this"))
noquote(one_table[3] |> strsplit("Agree strongly                               9      50%        38%"))
noquote(one_table |> strsplit("  "))
```
